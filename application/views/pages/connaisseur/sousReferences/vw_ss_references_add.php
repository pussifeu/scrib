...
<div class="modal fade" id="create-lot">
    <div class="modal-dialog modal-md">
        <form id="create-lot-form" class="create-form" action="<?= base_url('connaisseur/sousReferences/add') ?>" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="text-primary"><?= $this->lang->line('label_ss_references_creation') ?></h4>
                </div>
                        ...
                        <div class="row">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php loadViewElement(array(
                                        'label'=>$this->lang->line('label_ss_references_name'),
                                        'type'=>'text', 'id'=>'ss-reference-name',
                                        'name'=>'ss-reference-name',
                                        'placeholder' =>'',
                                        'required' =>'required',
                                        'col_md_div' => 'col-md-12',
                                        'col_lg_label' => 'col-lg-5',
